...
import * as SpanTreeTag from "../SpanTreeTag.js"
import * as Tracer from "../Tracer.js"

// ============================================
// Types (re-exported from SpanTreeTag.ts)
// ============================================

/** @internal */
export type SpanTreeConfig = SpanTreeTag.SpanTreeConfig
/** @internal */
export type SpanInfo = SpanTreeTag.SpanInfo
/** @internal */
export type TraceSummary = SpanTreeTag.TraceSummary
/** @internal */
export type SpanTreeMemoryStats = SpanTreeTag.SpanTreeMemoryStats
/** @internal */
export type SpanTreeStats = SpanTreeTag.SpanTreeStats
/** @internal */
export type SpanTreeService = SpanTreeTag.SpanTreeService
...
// ============================================
// Service Tag (re-exported from SpanTreeTag.ts)
// ============================================

/** @internal */
export const SpanTree = SpanTreeTag.SpanTree
/** @internal */
export type SpanTree = SpanTreeTag.SpanTree
...
export const makeTracer: Effect.Effect<EffectTracer.Tracer, never, SpanTree | Tracer.OtelTracer> = Effect.gen(
  function*() {
    // Cast to internal type to access recording methods
    const spanTreeService = (yield* SpanTree) as SpanTreeServiceInternal
